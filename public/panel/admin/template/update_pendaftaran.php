...
<?php
    ...
    $tgl_input = htmlspecialchars($_POST['Y-M-D']);
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="pendaftaran.php">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nis" id="nis" placeholder="NIS" value="<?= $edit['nis'] ?>"readonly>
                      </div>
                      <div class="form-group">
                        <label for="namasiswa3">Nama Siswa</label>
                        <input type="text" class="form-control" name="nama_siswa" id="nama_siswa" placeholder="Nama Siswa"value="<?= $edit['nama_siswa'] ?>" required>
                      </div>
                      <div class="form-group">
                        <label for="alamatd4">Alamat</label>
                        <input type="textarea" class="form-control" id="alamat" name="alamat" placeholder="alamat" value="<?= $edit['alamat'] ?>" required>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="input ur acc name"value="<?= $edit['nama'] ?>" required>
                      </div>
                    
                            <div class="form-group">
                                <label for="name6">Tempat Lahir</label> 
                                <input type="text" class="form-control form-control-user" id="tmp_lahir" name="tmp_lahir" placeholder="Tempat Lahir" value="<?= $edit['tmp_lahir'] ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Status</label>
                                <select class="form-control" name="status" id="status" value="<?= $edit['status'] ?>">
                            ...
                            <div class="form-group">
                                <label>Negara</label>
                                <select class="form-control" name="negara" id="negara" value="<?= $edit['negara'] ?>">
                            ...
                            <div class="form-group">
                                <label>Agama</label>
                                <select class="form-control" name="agama" id="agama" value="<?= $edit['agama'] ?>">
                            ...
                            <div class="form-group">
                                <label>Kelas</label>
                                <select class="form-control" name="kelas" id="kelas" value="<?= $edit['kelas'] ?>">
