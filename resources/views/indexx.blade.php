...
@section('content')
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5" src="assets/img/arya.jpeg" alt="..." />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">King Arya Nugraha</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Executif Directur Ekonomic World Bank - CEO of Kopi Kenangan - Producer Marvel Studios</p>
            </div>
        </header>
        <!-- Portfolio Section-->
